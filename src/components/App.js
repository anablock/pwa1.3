      ...
      <Route
        render={({ location }) => (
          <div style={styles.fill}>
            ...
            <ul style={styles.nav}>
              <NavLink to="/hsl/10/90/50">About</NavLink>
              <NavLink to="/hsl/120/100/40">Support</NavLink>
              <NavLink to="/rgb/33/150/243">Services</NavLink>
              <NavLink to="/rgb/240/98/146"></NavLink>
            </ul>
